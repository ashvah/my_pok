...
#define POK_CONFIG_SCHEDULING_SLOTS_ALLOCATION                                 \
  { 0, 1, 0, 1 }
#define POK_CONFIG_GLOBAL_SCHEDULER POK_SCHED_GLOBAL_EDF
#define POK_CONFIG_SCHEDULING_SLOTS_DEADLINE { 4000000000, 2000000000, 8000000000, 7000000000}
...
#define POK_NEEDS_SCHED_GLOBAL_EDF 1

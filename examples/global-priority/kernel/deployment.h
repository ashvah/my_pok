...
#define POK_CONFIG_SCHEDULING_SLOTS_ALLOCATION                                 \
  { 0, 1, 0, 1 }
#define POK_CONFIG_GLOBAL_SCHEDULER POK_SCHED_GLOBAL_PRIORITY
#define POK_CONFIG_SCHEDULING_SLOTS_PRIORITY { 1, 4, 2, 3}
...
#define POK_NEEDS_SCHED_GLOBAL_PRIORITY 1

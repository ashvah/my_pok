...
#define POK_CONFIG_SCHEDULING_SLOTS                                            \
  { 2000000000, 4000000000, 1000000000, 3000000000 }
#define POK_CONFIG_SCHEDULING_SLOTS_ALLOCATION                                 \
  { 0, 1, 0, 1 }
#define POK_CONFIG_GLOBAL_SCHEDULER POK_SCHED_GLOBAL_WRR
#define POK_CONFIG_SCHEDULING_SLOTS_TIME_SLICE 1000000000
...
#define POK_NEEDS_SCHED_GLOBAL_WRR 1
